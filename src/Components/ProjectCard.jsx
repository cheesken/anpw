    ...
    >
      <div className="h-full relative bg-gradient-to-br from-white/90 via-white/85 to-white/80 backdrop-blur-xl rounded-[2rem] p-6 md:p-8 transition-all duration-500 flex flex-col border-2 border-[#ba7893]/40 shadow-[0_20px_60px_rgba(186,120,147,0.25)] hover:shadow-[0_30px_80px_rgba(186,120,147,0.35)] hover:border-[#ba7893]/60 group overflow-hidden cursor-pointer">
        ...
        <div className="flex items-start gap-4 md:gap-5 mb-4 relative z-10">
          <div className="w-16 h-16 md:w-20 md:h-20 rounded-3xl bg-gradient-to-br from-[#ba7893] via-[#c98ba4] to-[#e9b6b5] flex items-center justify-center text-3xl md:text-4xl shadow-2xl flex-shrink-0 relative overflow-hidden">
            {/* Shine effect */}
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-2xl md:text-3xl font-bold text-[#342d66] leading-tight group-hover:text-[#5a6cb8] transition-colors duration-300 mb-2">
              {project.name}
            </h3>
          </div>

          {/* GitHub Icon - Fixed Position - Only show if link exists */}
          {project.github && (
            <a
              href={project.github}
              target="_blank"
